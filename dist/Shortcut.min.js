...
class Shortcut {
   ...
   * @param {object} [options={}] - The Shortcut object, not mandatory
   ...
   * @return {object} - The Shortcut singleton instance */
  constructor(options = {}) {
    ...
    if (typeof options.keyEvent !== 'string') {
   ...
   * shortcut.</blockquote>
   * @param {string} keyString - The raw shortcut string that is defined when registering an event
   * @return {boolean=false} - The existence state of given key string */
...
/***/ 0:
/*!*****************************!*\
  !*** multi src/Shortcut.js ***!
  \*****************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! src/Shortcut.js */"./src/Shortcut.js");
